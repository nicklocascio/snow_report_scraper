...
def parse_data(response):
	...
	for resort in resorts:
		name = resort.find_all("div", class_="title-location")
		print(name)

		snow = resort.find_all("div", class_="text snow")
		if(snow):
			print(snow)
		else:
			snow = resort.find_all("div", class_="text highsnow")
			if(snow):
				print(snow)
			else:
				snow = resort.find_all("div", class_="text nosnow")
				print(snow)
